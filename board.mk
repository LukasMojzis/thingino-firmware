...
NOCAMERA_TARGETS := help bootstrap setup-hooks update update-buildroot update-buildroot-patches reset-buildroot apply-buildroot-overrides download-cache agent-info tftpd-start tftpd-stop tftpd-restart tftpd-status tftpd-logs
